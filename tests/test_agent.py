...
from wmagent.agent.model import AgentOutput, DreamerStyleAgent
...
def test_dreamer_style_agent_forward_and_select_shape():
    agent = DreamerStyleAgent(in_channels=4, action_dim=12, horizon=5, hidden=32)
    ...
    contextual_agent = DreamerStyleAgent(
        in_channels=4,
        action_dim=12,
        horizon=5,
        n_candidates=7,
