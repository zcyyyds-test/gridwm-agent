...
Drives the live CloudPSS IEEE39 model: ``Model.fetch -> updateComponent ->
Model.update -> Model.run -> result.waitFor -> result.getPlots``.
"""
...
_DEFAULT_FAULT_KEY = os.environ.get("GRIDWM_FAULT_KEY", "canvas_0_965")
