...
class LatentGraphWorldModel(WorldModel):
    """Deterministic latent recurrent dynamics model with graph
    message-passing layers. **Note**: trained against
    ``data/graph_ieee39.h5``, which is a zero-feature fully-connected
    placeholder topology — the graph layers therefore do not encode an
    IEEE-39 electrical prior. See README → Caveats."""
