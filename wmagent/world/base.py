...
The model package answers "can we predict the next state?". This system
layer answers the application-facing question: "can a downstream caller
ask the world model to imagine futures, score them, and rank an event
space?"
"""
