"""Training loop for the Dreamer-style wm-agent agent."""
...
class AgentTrainConfig:
    ...
    critic_pearson_loss_weight: float = 0.5
    ...
    *,
    ...
    for batch in loader:
        ...
        critic_loss = (
            ...
            + float(cfg.critic_pearson_loss_weight)
            * _critic_pearson_loss(out.values, risk_norm)
        )
