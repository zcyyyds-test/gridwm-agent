"""Export a compact wm-agent world-model playground snapshot.
...
def main() -> int:
    ...
    parser.add_argument("run_dir", type=Path, help="V2 run directory, e.g. outputs/run_3acec7d14d")
    ...
    payload = {
        "meta": {
            "name": "wm-agent Playground Snapshot",
